...
var.name <- 'delta_tas' ##'alpha_tas' ##
morph.title <- 'Delta TAS' ##'Alpha Shortwave' ##'Alpha Tasmax/Tasmin' ##
morph.name <- 'delta_tas' ##'alpha_rsds' ##'alpha_tasmax_tasmin'  ##
past.int <- '1998-2014'
proj.int <- '2041-2070'
